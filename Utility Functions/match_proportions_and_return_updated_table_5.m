function [table_with_new_proportions] = match_proportions_and_return_updated_table_5(human_data_table,original_cluster_counts_to_match)
...
for i=1:length(unique_clusters)
    ...
    sample = datasample(table_with_only_curr_clust,original_cluster_counts_to_match(i));
    if size(sample,1) >1
