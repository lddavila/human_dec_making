function create3d_cluster_plot(name_of_dir_with_file,name_of_file,colors,type_of_data,the_title,x,y,z,dir_to_save_figure_to,rat_stats_map,date_created)
