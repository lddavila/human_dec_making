function all_psych_data = plot_avg_spec_cluster_psychs_for_whole_experiment(spectral_table, all_data, story_types, save_to, want_plot)
...
for s = 1:length(story_types)
    ...
    if want_plot
        create_avg_psych_for_whole_experiment(sesh_data,psych_to_cluster,story_type + " spectral",save_to,story_type)
    end
end
end