function [] = call_FCM_for_each_row_of_data_for_rat(table_of_dir,centers,directory_where_cluster_table_should_be_saved)
...
for i=1:height(table_of_dir)
    ...
    called_by = "call_FCM_for_each_row_of_data_for_rat";
    if isempty(centers)
        run_3d_fcm_analysis_for_rat(xVsYVsZ,labels,xAxis,yAxis,zAxis,experiment,called_by,[],cluster_table_dir_abs)
    else
        run_3d_fcm_analysis_for_rat(xVsYVsZ,labels,xAxis,yAxis,zAxis,experiment,called_by,centers{i},cluster_table_dir_abs)
    end
end
end