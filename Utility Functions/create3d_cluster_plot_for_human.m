function create3d_cluster_plot_for_human(human_data_table,colors,type_of_data,the_title,x,y,z,dir_to_save_figure_to,human_stats_map,date_created,version_name ...
    )
