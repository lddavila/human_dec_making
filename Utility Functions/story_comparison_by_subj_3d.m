function story_features = story_comparison_by_subj_3d(story_types, home_dir_name, C, sigmoid_type, save)
...
for s = 1:length(story_types)
    ...
    humanTable = stoppingPointsSigmoidClustering(1, dirName); %get the sigmoid data and put it into a table
