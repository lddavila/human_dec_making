function [] = plot_spider_plots_ontop_of_eachother_include_sig(probabilities, point_labels,title_of_figure,legend_strings,dir_to_save_things_to,the_subtitle)
figure;
axes_limits = [zeros(1,size(probabilities,2));max(probabilities)+0.05];
