function create3d_cluster_plot_for_human_hunger(human_data_table,colors,type_of_data,the_title,dir_to_save_figure_to,human_stats_map,version_name,thresholds,unique_clusters,p_from_chi_squared)
...
title([the_title,...
    ...
    "Created By create3d\_cluster\_plot\_for\_human\_hunger.m", ...
    version_name])
xlabel("log(abs(max))")
