function try_different_validation_methods_2(table_of_dir,directory_where_cluster_table_should_be_saved,epsilon,given_number_of_clusters,colors)
table_of_data = cell2table(cell(0,5),"VariableNames",["A","B","C","D","E","F"]);
