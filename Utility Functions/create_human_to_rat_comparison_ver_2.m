function create_human_to_rat_comparison_ver_2(name_of_rat_file,human_cluster_table,directory_of_rat_file,b_dist_plots_dir,colors)
...
for i=1:length(rat_clusters)
    ...
    scatter3(array_of_current_cluster_data_for_rat(:,1),array_of_current_cluster_data_for_rat(:,2),array_of_current_cluster_data_for_rat(:,3),'o','MarkerEdgeColor',current_rat_color);
    hold on;
    ...
    for j=1:length(human_clusters)
        ...
        scatter3(array_of_current_cluster_data_for_human(:,1),array_of_current_cluster_data_for_human(:,2),array_of_current_cluster_data_for_human(:,3),'x','MarkerEdgeColor',current_human_color);
    ...
    X = categorical({'1','2','3','4','5','6'});
    X = reordercats(X,{'1','2','3','4','5','6'});
    title(strcat("Rat Cluster ",string(i)," Compared to Human Clusters"))
    % subtitle("Created by create\_fifth\_plot.m")
    legend(strcat("Rat Cluster ",string(i)),"Human Cluster 1","Human Cluster 2","Human Cluster 3","Human Cluster 4","Human Cluster 5","Human Cluster 6",'Location','best')
