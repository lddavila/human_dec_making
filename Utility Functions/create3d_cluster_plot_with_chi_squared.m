function create3d_cluster_plot_with_chi_squared(name_of_dir_with_file,name_of_file,colors,type_of_data,the_title,x,y,z,dir_to_save_figure_to,rat_stats_map,date_created,version_name,p_value_from_chi_squared)
...
title([the_title,...
    ...
    version_name, ...
    strcat("P-Value From Chi-Squared:",string(p_value_from_chi_squared))])
xlabel(x)
ylabel(y)
zlabel(z)
