function [] = create_a_bhaat_distance_tree_for_rat(data_table,dir_to_save_figs_to,human_stats_map,type_of_data,the_title,version)
    ...
    title([the_title, ...
        strcat("Number Of Subjects: ",string(human_stats_map('Number Of Unique Subjects'))), ...
        strcat("Number of Sessions: ",string(human_stats_map('Number of Data Points'))), ...
        strcat("Date Created:",string(datetime("today",'Format','MM-d-yyyy'))), ...
        "Created by create\_a\_bhaat\_distance\_tree\_for\_rat.m" ...
        ,version])
    c = colorbar;
