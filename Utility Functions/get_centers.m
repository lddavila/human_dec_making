function [centers] = get_centers(xVsY,labels,xAxis,yAxis,feature,experiment,called_by)
%% format underscores
...
xlabel(xAxis);
ylabel(yAxis);
title(strcat(xAxis," Vs ",yAxis));
subtitle(strcat("Created By get\_centers.m, called by ", called_by))
xlim([-20,20]);
ylim([-20,20]);
