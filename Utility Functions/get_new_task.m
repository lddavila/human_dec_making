function [adj_results, r_ratings, c_ratings] = get_new_task()
...
for i = 1:length(unique_ids)
    ...
    for s = 1:length(unique_stories)
        ...
        r_dict = py.helper_old_task.convert(reward_prefs, r_levels, trial_date);
        c_dict = py.helper_old_task.convert(cost_prefs, c_levels, trial_date);
