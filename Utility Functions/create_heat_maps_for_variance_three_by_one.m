function [] = create_heat_maps_for_variance_three_by_one(data_table,dir_to_save_figs_to,do_the_simplifcation_or_dont)
    ...
    function [] = create_subplot(do_the_simplifcation_or_dont,simple_array_cell,unique_experiments,dimensions_array,which_dimension,k)
        ...
        if do_the_simplifcation_or_dont
            title([strcat("Change in Variance Cluster ",string(k)," Across All Experiments For ", dimensions_array(which_dimension)),"by 2 sample F test", "0: Not Significant"])
        else
