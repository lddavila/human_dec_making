function [] = mask_given_data_and_create_heat_map(mask_options,original_matrix,dir_to_save_figs_to,x_y_ticks,the_title,cell_label_format,human_stats_map)
    ...
    function [] = create_the_fig(dir_to_save_figs_to,masked_matrix,mask_option,x_y_ticks,the_title,cell_label_format,human_stats_map)
        ...
        if ~isempty(mask_option)
            ...
            saveas(gcf,strcat(dir_to_save_figs_to,"\",strjoin(mask_option)," ",the_title,".fig"),"fig")
        else
